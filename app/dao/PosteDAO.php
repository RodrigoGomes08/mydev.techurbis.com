...
class PosteDAO
{
    ...
    {
        $sql = "SELECT cu.id, cu.id_freguesia, cu.id_estado, cu.longitude, cu.latitude,
    ...
    {
        $sql = "SELECT id, id_freguesia, id_estado, longitude, latitude FROM candeeiro_urbanos ORDER BY id ASC";
        $stmt = $this->conn->prepare($sql);
        $stmt->execute();
        $postes = [];
    ...
    {
        $sql = "SELECT id, id_freguesia, id_estado, longitude, latitude FROM candeeiro_urbanos WHERE id = :id";
        $stmt = $this->conn->prepare($sql);
    ...
    public function createPoste($id, $id_freguesia, $id_estado, $longitude, $latitude)
    {
        ...
        $sql = "
            INSERT INTO candeeiro_urbanos
                (id, id_freguesia, id_estado, longitude, latitude)
            VALUES
                (:id, :id_freguesia, :id_estado, :longitude, :latitude)
        ";
    ...
    public function posteUpdateDAO($id, $id_freguesia, $id_estado, $longitude, $latitude)
    {
        try {
            $sql = "UPDATE candeeiro_urbanos SET id_freguesia = ?, id_estado = ?, longitude = ?, latitude = ? WHERE id = ?";

            $stmt = $this->conn->prepare($sql);
            $stmt->execute([$id_freguesia, $id_estado, $longitude, $latitude, $id]);
