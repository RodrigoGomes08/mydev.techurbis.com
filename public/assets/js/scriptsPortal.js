(function () {
    ...
    if (listaPostes && modalPosteEl) {
        ...
        if (btnPesquisar) btnPesquisar.addEventListener('click', () => {
            ...
            const resultado = valor
                ? postes.filter(p => String(p[campoSelecionado]).toLowerCase().includes(valor))
                : postes;
    ...
    if (gridParques) {
        ...
        let parques = [
            {
                nome: 'Parque Central',
                capacidade: 250, ocupados: 100,
                tipo: 'Subterrâneo',
                tarifa: 1.50,
                morada: 'Av. Central, Loures',
                horario: '00h–24h',
                mr: 8, ev: 4,
                lat: 38.8300, lng: -9.1700,
            },
            {
                nome: 'Parque Norte',
                capacidade: 180, ocupados: 153,
                tipo: 'Coberto',
                tarifa: 1.00,
                morada: 'Rua do Norte, Loures',
                horario: '07h–22h',
                mr: 6, ev: 2,
                lat: 38.8350, lng: -9.1680,
            },
            {
                nome: 'Parque Sul',
                capacidade: 120, ocupados: 42,
                tipo: 'Descoberto',
                tarifa: 0.50,
                morada: 'Rua do Sul, Sacavém',
                horario: '08h–20h',
                mr: 4, ev: 0,
                lat: 38.7900, lng: -9.1100,
            },
            {
                nome: 'Parque Oriente',
                capacidade: 300, ocupados: 261,
                tipo: 'Subterrâneo',
                tarifa: 2.00,
                morada: 'Av. Oriente, Moscavide',
                horario: '00h–24h',
                mr: 10, ev: 6,
                lat: 38.7700, lng: -9.1000,
            },
            {
                nome: 'Parque Camarate',
                capacidade: 90, ocupados: 38,
                tipo: 'Descoberto',
                tarifa: 0.00,
                morada: 'Largo Principal, Camarate',
                horario: '00h–24h',
                mr: 3, ev: 0,
                lat: 38.8029, lng: -9.1175,
            },
            {
                nome: 'Parque Santa Iria',
                capacidade: 200, ocupados: 148,
                tipo: 'Coberto',
                tarifa: 1.20,
        ...
        function renderParques(lista) {
            ...
            document.querySelectorAll('.btn-parque-mapa').forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    if (titleEl) titleEl.textContent = this.dataset.nome + ' — Localização';
                    if (iframeEl) iframeEl.src = `https://www.google.com/maps?q=${this.dataset.lat},${this.dataset.lng}&z=16&output=embed`;
        ...
        function abrirDetalhe(index) {
            ...
            const hist = [
                ...
                { hora: '16:00', pct: 80 }, { hora: '18:00', pct: pct },
            ];
