<?php include __DIR__ . "/../../includes/header.php"; ?>
            ...
            <section id="cidade" class="adm-page active">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
                    ...
                    <div class="d-flex gap-2">
                        <button class="btn btn-admin-primary btn-sm" type="button" data-bs-toggle="collapse"
                            data-bs-target="#painelInfo">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-6 col-md-3">
                        <div class="pkpi-card">
                            <div class="pkpi-icon" style="background:#e8edff;color:#435ebe;"><i class="bi bi-wifi"></i>
                            </div>
                            <div>
                                <div class="pkpi-value">247</div>
                                <div class="pkpi-label">Sensores IoT Ativos</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-md-3">
                        <div class="pkpi-card">
                            ...
                            <div>
                                <div class="pkpi-value text-warning">1 234</div>
                                <div class="pkpi-label">Luminárias Inteligentes</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-md-3">
                        <div class="pkpi-card">
                            ...
                            <div>
                                <div class="pkpi-value text-success">45</div>
                                <div class="pkpi-label">Estações Carregamento</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-md-3">
                        <div class="pkpi-card">
                            ...
                            <div>
                                <div class="pkpi-value text-danger">89</div>
                                <div class="pkpi-label">Câmaras de Vigilância</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="collapse mb-4" id="painelInfo">
                    <div class="card-admin">
                        <div class="card-body">
                            <h5 class="card-title mb-3"><i class="bi bi-cpu me-2" style="color:#435ebe;"></i>Recursos
                                Disponíveis</h5>
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div>
                                        <div class="d-flex justify-content-between mb-1" style="font-size:0.85rem;">
                                            <span><i class="bi bi-wifi me-1"></i>Sensores IoT Online</span><span
                                                class="fw-bold">247 / 260</span></div>
                                        <div class="parque-prog">
                                            <div class="parque-prog-bar normal" style="width:95%;"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div>
                                        <div class="d-flex justify-content-between mb-1" style="font-size:0.85rem;">
                                            <span><i class="bi bi-lightbulb me-1"></i>Luminárias
                                                Operacionais</span><span class="fw-bold">1 190 / 1 234</span></div>
                                        <div class="parque-prog">
                                            <div class="parque-prog-bar normal" style="width:96%;"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div>
                                        <div class="d-flex justify-content-between mb-1" style="font-size:0.85rem;">
                                            <span><i class="bi bi-lightning-charge me-1"></i>Estações
                                                Operacionais</span><span class="fw-bold">42 / 45</span></div>
                                        <div class="parque-prog">
                                            <div class="parque-prog-bar normal" style="width:93%;"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div>
                                        <div class="d-flex justify-content-between mb-1" style="font-size:0.85rem;">
                                            <span><i class="bi bi-camera me-1"></i>Câmaras Online</span><span
                                                class="fw-bold">85 / 89</span></div>
                                        <div class="parque-prog">
                                            <div class="parque-prog-bar normal" style="width:95%;"></div>
                                        </div>
                                    </div>
                        ...
                        <div class="parque-card normal">
                            <div class="parque-card-header">
                                <div class="parque-titulo">
                                    <span><i class="bi bi-thermometer-half me-2"
                                            style="color:#e74c3c;"></i>Ambiente</span>
                                    <span class="parque-tag ev">Atualizado</span>
                                </div>
                                <div class="parque-subtitulo"><i class="bi bi-circle-fill"
                                        style="color:#2ecc71;font-size:0.5rem;"></i>Condições normais</div>
                            </div>
                            ...
                            <div class="parque-actions">
                                <button class="btn btn-sm btn-outline-secondary btn-atualizar-ambiente"><i
                                        class="bi bi-arrow-clockwise me-1"></i>Atualizar</button>
                                <button class="btn btn-sm btn-outline-primary btn-historico-ambiente"><i
                                        class="bi bi-bar-chart me-1"></i>Histórico</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="parque-card normal">
                            <div class="parque-card-header">
                                ...
                                <div class="parque-subtitulo"><i class="bi bi-circle-fill"
                                        style="color:#2ecc71;font-size:0.5rem;"></i>Fluxo dentro do esperado</div>
                            </div>
                            <div class="parque-info-grid">
                                <div class="parque-info-item">
                            ...
                            <div class="parque-actions">
                                <button class="btn btn-sm btn-outline-secondary btn-mapa-trafego"><i
                                        class="bi bi-map me-1"></i>Ver Mapa</button>
                                <button class="btn btn-sm btn-outline-primary btn-detalhe-trafego"><i
                                        class="bi bi-eye me-1"></i>Detalhes</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="parque-card normal">
                            <div class="parque-card-header">
                                ...
                                <div class="parque-subtitulo"><i class="bi bi-circle-fill"
                                        style="color:#2ecc71;font-size:0.5rem;"></i>Recolha a cumprir o calendário</div>
                            </div>
                            <div class="parque-info-grid">
                                <div class="parque-info-item">
                            ...
                            <div class="parque-actions">
                                <button class="btn btn-sm btn-outline-secondary btn-calendario-residuos"><i
                                        class="bi bi-calendar me-1"></i>Calendário</button>
                                <button class="btn btn-sm btn-outline-primary btn-detalhe-residuos"><i
                                        class="bi bi-eye me-1"></i>Detalhes</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="alert alert-success mb-0">
                                    ...
                                    <strong>Sucesso!</strong> O relatório foi enviado com sucesso e será analisado pela
                                    equipa de suporte.
                                </div>
                            </div>
    ...
    <button class="btn btn-dark position-fixed bottom-0 end-0 m-4" data-bs-toggle="offcanvas"
        data-bs-target="#menuExtra">
        ...
        <div class="offcanvas-body">
            <div class="list-group">
                <div class="list-group-item d-flex align-items-center gap-3">
                    <span
                        style="background:#fde8e8;color:#e74c3c;border-radius:10px;padding:8px 10px;font-size:1.2rem;"><i
                ...
                <div class="list-group-item d-flex align-items-center gap-3">
                    <span
                        style="background:#e8edff;color:#435ebe;border-radius:10px;padding:8px 10px;font-size:1.2rem;"><i
                ...
                <div class="list-group-item d-flex align-items-center gap-3">
                    <span
                        style="background:#e6f9ef;color:#27ae60;border-radius:10px;padding:8px 10px;font-size:1.2rem;"><i
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    <div style="width:100%;height:420px;">
                        <iframe id="iframeMapaCidade" src="" width="100%" height="100%" style="border:0;"
                            loading="lazy"></iframe>
                    </div>
                </div>
            </div>
