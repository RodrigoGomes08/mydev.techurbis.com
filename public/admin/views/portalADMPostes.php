    ...
    <section id="postes" class="adm-page active">
        ...
        <div class="row g-3 mb-4">
            <div class="col-6 col-md-3">
                <div class="pkpi-card">
                    <div class="pkpi-icon" style="background:#e8edff;color:#435ebe;"><i
                            class="bi bi-lightbulb-fill"></i></div>
                    <div>
                        <div class="pkpi-value" id="pkpi-postes-total">—</div>
            ...
            <div class="col-6 col-md-3">
                <div class="pkpi-card">
                    ...
                    <div>
                        <div class="pkpi-value text-success" id="pkpi-postes-operacionais">—</div>
            ...
            <div class="col-6 col-md-3">
                <div class="pkpi-card">
                    <div class="pkpi-icon" style="background:#fde8e8;color:#e74c3c;"><i class="bi bi-x-circle-fill"></i>
                    </div>
                    <div>
                        <div class="pkpi-value text-danger" id="pkpi-postes-avariados">—</div>
            ...
            <div class="col-6 col-md-3">
                <div class="pkpi-card">
                    ...
                    <div>
                        <div class="pkpi-value text-warning" id="pkpi-postes-manutencao">—</div>
        ...
        <div class="d-flex gap-2 mb-4 flex-wrap">
            <div class="input-group" style="max-width:300px;">
                ...
                <input id="searchInput" type="text" class="form-control border-start-0 ps-0" placeholder="Pesquisar..."
                    disabled>
            </div>
            <div class="dropdown">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-2 mb-3">
                        ...
                        <div class="col-6">
                            ...
                            <input type="number" step="any" class="form-control" id="inputLatitude"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="inputObservacoes" rows="3"
                            placeholder="Descrição do estado ou ocorrência..."></textarea>
                    </div>
                </div>
